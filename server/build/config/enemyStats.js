...
export const ENEMY_STATS = {
    ...
    orck: {
        id: "orck",
        title: "Orck",
        description: "A hulking greenskin brute. Slower but tougher than a tyranid, with a larger frame.",
        maxHealth: 500,
    ...
    tau: {
        id: "tau",
        title: "Tau",
        description: "A ranged Tau warrior. Keeps its distance and fires heavy bolter rounds; high damage, low health.",
    ...
    mechanicus: {
        id: "mechanicus",
        title: "Mechanicus",
        description: "A cyborg adept of the Machine God. Buffs itself, shocks its foes, and repairs its allies; moderate health and damage.",
        maxHealth: 300,
        moveSpeed: 30,
        attack: 150,
        defence: 0.01,
